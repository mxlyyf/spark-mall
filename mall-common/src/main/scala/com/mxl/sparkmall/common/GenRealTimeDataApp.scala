...
import com.mxl.sparkmall.common.bean.CityInfo
import com.mxl.sparkmall.common.util.{RandomOptions, RandomUtil}
import org.apache.kafka.clients.producer.{KafkaProducer, ProducerRecord}

import scala.collection.mutable.ArrayBuffer

object GenRealTimeDataApp {
  ...
  def mockRealTimeData() = {
    ...
    (1 to 50).foreach {
      i => {
        ...
        val userid = RandomUtil.randomInt(100, 105)
        val adid = RandomUtil.randomInt(1, 5)
